    ...
    public class SkillsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new CommandResponse(false, "An exception occurred during SkillsGet."));
            }
        }
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new CommandResponse(false, "An exception occurred during SkillsGetById."));
            }
        }
        ...
        public async Task<IActionResult> Post(SkillCreateRequest request)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new CommandResponse(false, "An exception occurred during SkillsPost."));
            }
        }
        ...
        public async Task<IActionResult> Put(SkillUpdateRequest request)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new CommandResponse(false, "An exception occurred during SkillsPut."));
            }
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new CommandResponse(false, "An exception occurred during SkillsDelete."));
            }
        }
    }
}
